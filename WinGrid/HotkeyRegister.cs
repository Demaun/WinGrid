...
/// <summary>
/// via https://www.pinvoke.net/default.aspx/user32/RegisterHotKey.html
/// </summary>
...
namespace WinGrid
{
    ...
    public class HotKeyRegister : IMessageFilter, IDisposable
    {
        ...
        public HotKeyRegister(IntPtr handle, int id, KeyModifiers modifiers, Keys key, Action action)
        {
            ...
            HotKeyPressed += (s, e) => action?.Invoke();
        ...
        {
            bool isKeyRegistered = PInvoke.RegisterHotKey(Handle, ID, Modifiers, Key);
            ...
            if (!isKeyRegistered)
            {
                ...
                PInvoke.UnregisterHotKey(IntPtr.Zero, ID);

                // Try to register the hotkey again.
                isKeyRegistered = PInvoke.RegisterHotKey(Handle, ID, Modifiers, Key);
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (disposing)
            {
                ...
                PInvoke.UnregisterHotKey(Handle, ID);
            }
